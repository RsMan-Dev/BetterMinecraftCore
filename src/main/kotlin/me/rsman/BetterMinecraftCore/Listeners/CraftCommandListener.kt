...
import me.rsman.BetterMinecraftCore.configs.containers.BmcCraftContainer.Companion.load
import me.rsman.BetterMinecraftCore.configs.containers.BmcCraftContainer.Companion.registerCrafts
...
class CraftCommandListener : Listener {
    ...
    fun onCraftInventoryClose(event: InventoryCloseEvent) {
        ...
        if (isShaped) {
            ...
            val bmcCraft = BmcShapedCraft()
            bmcCraft.shape = listOf(*schemesFormatted)
