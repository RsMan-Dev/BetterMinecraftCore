...
object DBManager {
    ...
    fun initConnection() {
        ...
        fr.rsman.betterMinecraftCore.BetterMinecraftCore.instance.logger.info("§3Initializing DB...")
        try {
            ...
            fr.rsman.betterMinecraftCore.BetterMinecraftCore.instance.logger.info("§bDB connected!")
        } catch (throwables: SQLException) {
            fr.rsman.betterMinecraftCore.BetterMinecraftCore.instance.logger.severe(throwables.toString())
            fr.rsman.betterMinecraftCore.BetterMinecraftCore.instance.logger.warning("§4Database connection not initialized, please setup config for mariaDB database, disabling plugin")
