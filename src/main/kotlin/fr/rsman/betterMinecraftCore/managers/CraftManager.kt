...
import fr.rsman.betterMinecraftCore.configs.models.BmcCraftSubContainer.Companion.convertItemSchemeToItemStack
...
import fr.rsman.betterMinecraftCore.managers.command.lang.MessageKeys
...
object CraftManager {
    ...
    fun openCraftingEditorInventory(commandManager: CommandManager, playerSender: Player, namespacedKey: NamespacedKey?, result: String?, nameKeyPair: String, resultCount: Int?, type: String, force: String?) {
        var result = result
        ...
        playerSender.persistentDataContainer.set(namespacedKey!!, PersistentDataType.STRING, "$nameKeyPair|$result|$resultCount|$type")
    }
}