...
import fr.rsman.betterMinecraftCore.extensions.getAtribute
import fr.rsman.betterMinecraftCore.extensions.update
...
object PlayerManager {
    ...
    private fun setEquippedAttributes(uuid: String?, attr: Map<String, Long>) {
    ...
    fun updatePlayerAttributes(player: Player) {
        ...
        mana = (mana!! + totalAttributes["mana"]!! * 0.02).roundToInt().coerceAtMost(totalAttributes["mana"]!!.toInt()).toFloat()
            .roundToInt().toLong()
