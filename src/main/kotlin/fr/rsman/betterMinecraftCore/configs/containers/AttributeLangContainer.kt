...
data class AttributeLangContainer(
    ...
    companion object {
        ...
        fun load() {
            instance = null
            fr.rsman.betterMinecraftCore.BetterMinecraftCore.logger.info("§3Loading Attributes lang...")
            val enchantLangContainerInstance = ConfigLoader.loadConfig("lang/attributes", AttributeLangContainer::class.java)
            fr.rsman.betterMinecraftCore.BetterMinecraftCore.logger.info("§bLoaded Attributes lang.")
